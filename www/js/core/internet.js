var Internet = {
    ...
    hostReachable: function(host) {
		//console.log("[Internet.hostReachable]");
        if (Internet.checkedHostOnce === false) {
            var result;
            if (!host) {
            ...
            try {
                ...
                Internet.checkedHostOnce = result;
                //console.log(result);
                return result;
            } catch (error) {
    ...
    getURLSource: function(url, data, spinner, callback) {
        ...
        //console.log("getURLSource: " + spinner);
        if (spinner === true) {
            $.mobile.loading("show");
        }
